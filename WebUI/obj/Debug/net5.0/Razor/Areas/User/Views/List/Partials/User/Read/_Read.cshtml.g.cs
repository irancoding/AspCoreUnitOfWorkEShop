#pragma checksum "D:\IranCoding\Projects\ASP Core\Project\AspCoreUnitOfWorkEShop\AspCoreUnitOfWorkEShop\WebUI\Areas\User\Views\List\Partials\User\Read\_Read.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "55f88fea8ae0f4104ce3c796a40d9d45733915e6"
// <auto-generated/>
#pragma warning disable 1591
[assembly: global::Microsoft.AspNetCore.Razor.Hosting.RazorCompiledItemAttribute(typeof(AspNetCore.Areas_User_Views_List_Partials_User_Read__Read), @"mvc.1.0.view", @"/Areas/User/Views/List/Partials/User/Read/_Read.cshtml")]
...
#nullable restore
#line 1 "D:\IranCoding\Projects\ASP Core\Project\AspCoreUnitOfWorkEShop\AspCoreUnitOfWorkEShop\WebUI\Areas\User\Views\List\Partials\User\Read\_Read.cshtml"
using Kendo.Mvc.UI;

#line default
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"55f88fea8ae0f4104ce3c796a40d9d45733915e6", @"/Areas/User/Views/List/Partials/User/Read/_Read.cshtml")]
    public class Areas_User_Views_List_Partials_User_Read__Read : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<Application.ViewModels.UserReadVm>
    {
...
<script id=""status-template"" type=""text/x-kendo-template"">
    ...
    # }
       ...
       <span class=""labe");
            WriteLiteral(@"l label-success label-pill label-inline mr-2"">فعال</span>
    # }
     else if(Type==-1) { #
...
");
            WriteLiteral(@"        <a class=""flex-grow-1 btn dir-rtl btn-sm btn-primary ms-2 p-2 d-flex align-items-center justify-content-center rounded-1"" href=""javascript:void(0)""  onclick='Panel(""#=Id#"")'>
            ورود به پنل
        </a>
...
<div class=""container px-2"">
    <div class=""k-rtl area"">
        ...
        ");
#nullable restore
#line 79 "D:\IranCoding\Projects\ASP Core\Project\AspCoreUnitOfWorkEShop\AspCoreUnitOfWorkEShop\WebUI\Areas\User\Views\List\Partials\User\Read\_Read.cshtml"
    Write(Html.Kendo().Grid<Application.ViewModels.UserVm>()
            .Name("grid")
            .ToolBar(toolbar =>
            {
...
<script type=""text/javascript"">
    ...
    function onChange(arg) {
        ...
        if (checkedNodes.length > 0) {
            ...
            $(""");
            WriteLiteral(@"#ListOrganizationId"").val(checkedNodes.join("",""));
        }
    }
...
<script>
    function _UserRole_Read() {
        ...
        $.ajax({
            url: """);
#nullable restore
#line 256 "D:\IranCoding\Projects\ASP Core\Project\AspCoreUnitOfWorkEShop\AspCoreUnitOfWorkEShop\WebUI\Areas\User\Views\List\Partials\User\Read\_Read.cshtml"
             Write(Url.Action("_ReadPermission", "UserRole", new { Area="User"}));
    ...
    <script>
        function _Create() {
            $.ajax({
                url: """);
#nullable restore
#line 272 "D:\IranCoding\Projects\ASP Core\Project\AspCoreUnitOfWorkEShop\AspCoreUnitOfWorkEShop\WebUI\Areas\User\Views\List\Partials\User\Read\_Read.cshtml"
                 Write(Url.Action("_Create", "List", new { Area="User"}));
    ...
    <script>
        function _Update(Id) {
            ...
            $.ajax({
                url: """);
#nullable restore
#line 286 "D:\IranCoding\Projects\ASP Core\Project\AspCoreUnitOfWorkEShop\AspCoreUnitOfWorkEShop\WebUI\Areas\User\Views\List\Partials\User\Read\_Read.cshtml"
                 Write(Url.Action("_Update", "List", new { Area = "User" }));
    ...
    <script>
        function _Delete(Id) {
            $.ajax({
                url: """);
#nullable restore
#line 298 "D:\IranCoding\Projects\ASP Core\Project\AspCoreUnitOfWorkEShop\AspCoreUnitOfWorkEShop\WebUI\Areas\User\Views\List\Partials\User\Read\_Read.cshtml"
                 Write(Url.Action("_Delete", "List", new { Area = "User" }));
    ...
    <script>
        function _Search() {
            $.ajax({
                url: """);
#nullable restore
#line 310 "D:\IranCoding\Projects\ASP Core\Project\AspCoreUnitOfWorkEShop\AspCoreUnitOfWorkEShop\WebUI\Areas\User\Views\List\Partials\User\Read\_Read.cshtml"
                 Write(Url.Action("_Search", "List", new { Area = "User" }));
    ...
    <script>
        function _ChangePassword(Id) {
            ...
            $.ajax({
                url: """);
#nullable restore
#line 324 "D:\IranCoding\Projects\ASP Core\Project\AspCoreUnitOfWorkEShop\AspCoreUnitOfWorkEShop\WebUI\Areas\User\Views\List\Partials\User\Read\_Read.cshtml"
                 Write(Url.Action("_ChangePassword", "List", new { Area = "User" }));
...
<script>
    function Panel(Id) {
        $.ajax({
            url: """);
#nullable restore
#line 337 "D:\IranCoding\Projects\ASP Core\Project\AspCoreUnitOfWorkEShop\AspCoreUnitOfWorkEShop\WebUI\Areas\User\Views\List\Partials\User\Read\_Read.cshtml"
             Write(Url.Action("Panel", "List", new { Area="User"}));
    ...
    <script>
        function _Permission(Id) {
            ...
            $.ajax({
                url: """);
#nullable restore
#line 355 "D:\IranCoding\Projects\ASP Core\Project\AspCoreUnitOfWorkEShop\AspCoreUnitOfWorkEShop\WebUI\Areas\User\Views\List\Partials\User\Read\_Read.cshtml"
                 Write(Url.Action("_Permission", "List", new { Area="User"}));
...
<style>
    ...
    .employee-name {
        ...
        [global::Microsoft.AspNetCore.Mvc.Razor.Internal.RazorInjectAttribute]
        public global::Microsoft.AspNetCore.Mvc.Rendering.IHtmlHelper<Application.ViewModels.UserReadVm> Html { get; private set; }
    }
}
